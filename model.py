...
class Train:
    space = {}
    model_file_name = 'uv_model/saved_model/finalized_model.json'
...
class Predict:
    ...
    def open_model(self):
        self.my_model = xgb.XGBRegressor()
        self.my_model.load_model(self.file_name) 
    ...
    def predict(self, id):
        ...
        return output.to_csv('output/output.csv')